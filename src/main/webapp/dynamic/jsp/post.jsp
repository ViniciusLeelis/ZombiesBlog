...
<!DOCTYPE html>
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body">
                            <form method="POST" align="center" action="novoComentario.action">        <!-- É enviado o comentário via POST !-->
                                ...
                                <div class="form-group">
                                    <button id="addComentario" type="submit" class="submitButton">Comentar</button>
                                </div>                     
                            </form>
                        ...
                        <section class="comment-content comment">
                            ...
                            <% if(session.getAttribute("usuario")==null)  {
                                 ...
                                 %> 
                                    ...
                                    <a href="excluirComentario.action"><button  onclick="alert('Comentário excluido')" type="submit" class="btn btn-danger">Excluir</button></a> 
                                    </form>         
                                <%} %>  
                        </section>
                    </article>
    ...
    <script>
        ...
        function addComentario() {
            if(comentario != null) {
            alert ("Você adicionou um comentário ! ");
            } else {
 ...
 <!--  Script para fazer o efeito de máquina de escrever no h1   !-->
