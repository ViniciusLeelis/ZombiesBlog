...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <!-- Inserir um novo usuário pelo metodo POST!-->         
           ...
           <div>
                   <div style="padding-top: 2%" class="col-md-12">
                        <form method="POST" action="Registrar.action">
                            ...
                            <div class="form-group">
                                <label >Apelido:</label>
                                <input name="apelido" id="apelido" type="text" class="form-control" id="insertApelido"  placeholder="Digite o seu apelido, por favor">
                            </div>
                            ...
                            <div align="center" class="form-group">
                                <button id="registrar" type="submit" class="submitButton">Cadastrar</button>
                            </div>                    
                        </form>
                    </div>	
            </div>
      ...
      <script>
        ...
        document.getElementById("registrar").addEventListener("click", addUsuario);
        function addUsuario() {
            alert ("Bem vindo !");
        } 
      </script>
