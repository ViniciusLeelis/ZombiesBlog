...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <div align="center" class="conteudo">
            <div  style="padding-top: 02px; padding-bottom: 25px;">
                ...
                <a href="addPost"><button class="submitButton">Adicionar tópico</button></a> 
            </div>
            <hr>
                   ...
                   <% for(Post p: posts) { %>
                    ...
                    <tr class="active">
                        ...
                        <td>
                            ...
                            <button onClick="alert('Post: excluido!')" type="submit" class="deleteButton">Excluir </button>
                            </form>
                            ...
                            <a href="Post?idPost=<%= p.getId() %>"><button  class="submitButton">Ver tópico </button></a>
                        </td>
                    </tr>
                            <% } %>  
                <!-- Fim do loop  -->
                ...
                <!-- Loop de tópicos existentes no blog  -->
                    <tr class="active">
                        ...
                        <td>
                            ...
                            <button onClick="alert('Usuario <%= x.getApelido() %> Excluido!')" type="submit" class="deleteButton">Excluir </button>
                            </form>                            
                        </td>
                    </tr>
                    <% }
