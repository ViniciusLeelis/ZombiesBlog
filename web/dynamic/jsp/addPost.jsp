            ...
            <div>
                    ...
                    <form method="POST" action="onRegister">
                        <div class="form-group">
                            <label>Título:</label>
                            <input type="text" class="form-control" id="insertName" placeholder="Digite o título da postagem:">
                        </div>
                        
                        
                        <div class="form-group">
                            <label >Conteúdo:</label>
                            <input type="text" class="form-control" id="insertApelido"  placeholder="Digite o conteúdo da postagem">
                        </div>
